const products = [
    { id: 1, cat: 'hardware', name: 'TP-Link Archer BE800', price: 350, descriptive: 'راوتر WiFi 7 الأحدث بسرعات خرافية تدعم حتى 19 جيجابت/ثانية.', img: 'https://tse4.mm.bing.net/th/id/OIP.W1njmflRB9E4OUqdAJAEWQHaHa?rs=1&pid=ImgDetMain&o=7&rm=3' },
    { id: 2, cat: 'hardware', name: 'Starlink Kit', price: 590, descriptive: 'محطة إنترنت الأقمار الصناعية للاتصال بالإنترنت في أي مكان في العالم.', img: 'https://tse1.mm.bing.net/th/id/OIP.2q9XDIIbGFlsV7b2p3gYnAHaEK?rs=1&pid=ImgDetMain&o=7&rm=3' }
];
let cart = [];
let lastOrderID = "";
